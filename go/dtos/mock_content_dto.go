...
type MockContentUrlDTO struct {
	...
	} `json:"urlData" binding:"required"`

	MockContentList []MockContentCreateDTO `json:"mockContentList" binding:"required,dive"` // dive validates each element in slice
}
...
type UpdateMockContentUrlDTO struct {
	...
	MockContentList []MockContentUpdateDTO `json:"mockContentList" binding:"required,dive"`
}
...
type GetMockedJSONParamsDTO struct {
	...
	IsForwardCall *bool  `json:"isForwardCall"` // From request body
}
